...
(function (root, factory) {
  ...
  Imgur.prototype = {
    ...
    createDragZone: function () {
      ...
      input = this.createEls('input', { type: 'file', id: 'upload-input', className: 'input', accept: 'image/*' });
        ...
        zone.addEventListener(event, function (e) {
          if (e.target && e.target.nodeName === 'INPUT' && e.target.type === 'file') {
            if (event === 'dragleave' || event === 'drop') {
              ...
              e.target.previousSibling.previousSibling.innerHTML = "prvo sejvaj pa tu dropaj";
            } else {
              e.target.parentNode.classList.add('dropzone-dragging');
              e.target.previousSibling.previousSibling.innerHTML = "SAD SAD SAD";
            }
          }
        }, false);
      });
